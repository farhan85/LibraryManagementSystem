...
public class AuthorToAttributeValueMapConverter extends Converter<Author, Map<String, AttributeValue>> {

    @Override
    @NotNull
    protected Map<String, AttributeValue> doForward(final Author author) {
    ...
    @Override
    @NotNull
    protected Author doBackward(final Map<String, AttributeValue> item) {
